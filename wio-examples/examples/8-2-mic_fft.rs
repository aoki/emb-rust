...
use eg::{egrectangle, image::*, pixelcolor::Rgb565, primitive_style};
...
fn main() -> ! {
    ...
    let button_buzzer = sets.buttons.button3.into_floating_input(&mut sets.port);
    ...
    loop {
        if button_buzzer.is_low().unwrap() {
